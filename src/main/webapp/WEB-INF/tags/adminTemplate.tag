                        ...
                        <li class="songs nav-parent " data-toggle="collapse">
                           ...
                           class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                            <ul id="song" class="nav iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                ...
                                <!-- <li><a class="nav-link" href="/zestreact/appnew/music/song-view"><span>Song Details</span></a> -->
                        </li>
                        </ul>
                        </li>


                        <!--<li class="playlists  nav-parent " data-toggle="collapse">
                     <a href="#playlist" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                        class="ripple rippleEffect"></span><i
                        class="ri-play-list-line iq-arrow-left"></i><span>Playlists</span><i
                        class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  <ul id="playlist" class="nav iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a class="nav-link" href="/zestreact/appnew/music/playlists"><span>Playlists</span></a></li>
                        <li><a class="nav-link" href="/zestreact/appnew/music/add-playlist"><span>Add
                                 Playlist</span></a></li>
                        <li><a class="nav-link" href="/zestreact/appnew/music/edit-playlist"><span>Edit
                                 Playlist</span></a></li>
                        <li><a class="nav-link" href="/zestreact/appnew/music/playlist-view"><span>View
                                 Playlist</span></a></li>
                     </ul>
                  </li>
