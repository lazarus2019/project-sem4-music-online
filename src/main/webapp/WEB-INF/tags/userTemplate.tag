...
<!-- CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/bootstrap-reboot.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/bootstrap-grid.min.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/select2.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/paymentfont.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/slider-radio.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/plyr.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/main.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/adminlte.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/all.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/icheck-bootstrap.min.css">

<!-- CSS Listen -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/1.3.0/css/line-awesome.min.css">

<!-- My custom CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/my_custom.css">

<!-- Sweetalert CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/sweetalert2/dist/sweetalert2.min.css">
	
<!-- Favicons -->
<link rel="icon" type="image/png"
	href="${pageContext.request.contextPath }/resources/user/icon/favicon-32x32.png"
	sizes="32x32">
...
<body>
		...
		<div class="header__content">
			<div class="header__logo">
				<a href="index.html"> <img
					src="${pageContext.request.contextPath }/resources/user/img/logo.svg"
					alt="">
				</a>
			</div>
			...
			<ul class="header__nav">
				...
				<li class="dropdown-btn"><a href="#" class="link">Library</a>
					<div class="dropdown-menu">
						<a href="releases.html"><i class="las la-music"></i> New
							Release</a> <a href="custom_playlist.html"><i
							class="las la-stream"></i> Playlist</a> <a href="liked_song.html"><i
							class="las la-heart"></i> Liked</a> <a href="recently_history.html"><i
							class="las la-headphones"></i> Recently Played</a> <a
							href="${pageContext.request.contextPath }/record-chart/index"><i
							class="las la-sort-numeric-down"></i> Record Chart</a>
					</div></li>
			...
			<form action="#" class="header__search">
				<input type="text" placeholder="Artist, track or podcast"
					class="input-search" onfocus="showResultContainer()">
				<button type="button">
					...
					<div class="artists-result result-box">
						...
						<div class="result-content grid-tl-6 mt-3 mb-3"
							...
							<c:forEach items="${ popularArtists}" var="artist" varStatus="i">
								<c:if test="${i.index < 6 }">
									<a href="${pageContext.request.contextPath}/artist/${artist.id}" class="artist-box" data-id="${artist.id }">
										<div class="artist-image-box">
											<img
												src="${pageContext.request.contextPath}/resources/user/img/artists/${artist.image}"
												alt="">
										</div>
					...
					<div class="track-result result-box">
						...
						<div class="result-content grid-tl-3 mt-3 mb-3"
							...
							<c:forEach items="${ newReleaseTracks}" var="track" varStatus="i">
								<c:if test="${i.index < 6 }">
									<div class="track-box" data-id="${track.id }">
								...
								<c:if test="${i.index < 6 }">
									<div class="album-box" data-id="${ album.id}">
										<div class="album-box-image">
											<img
												src="${pageContext.request.contextPath}/playlist/${album.thumbnail}"
												alt="">
										</div>
			...
			<div class="header__actions">
				...
				<div class="header__action header__action--note">
					<span>17</span> <a href="#" class="header__action-btn"><svg
					...
					<div class="header__drop">
						...
						<div class="header__note header__note--succ">
							...
							<p>
								<a href="#modal-info2" class="open-modal">Payment #51</a> was
								successful!
							</p>
						...
						<div class="header__note header__note--fail">
							...
							<p>
								<a href="#modal-info3" class="open-modal">Payment #50</a>
								failed!
							</p>
						...
						<div class="header__note header__note--info">
							...
							<p>
								<a href="#modal-info4" class="open-modal">Example</a> of
								notification.
							</p>
							<span>2 hours ago</span>
						</div>
						<div class="header__note header__note--gift">
							...
							<p>
								<a href="#modal-info5" class="open-modal">You have received
									a gift!</a>
							</p>
				...
				<div class="header__action header__action--signin">
					<a class="header__action-btn" href="signin.html"> <span>Sign
							in</span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
							<path
					...
					<div class="header__action-btn">
						<span>John Doe</span>
						<div class="user__box">
							<i class="las la-crown"></i> <img
								src="https://yt3.ggpht.com/IbzRdnm7aoMvV_fdLAAmL1D7IlJ3fQ-FA5kuRujQst_1MnQTNRO1wlrvjEVocAmsqIOLP6D34Q=s900-c-k-c0x00ffffff-no-rj"
								alt="" class="user__avatar">
							<div class="dropdown__user-menu">
								<a href="profile.html"> <i class="lar la-user-circle"></i>
									Profile
								</a> <a href="artist_tracks.html"> <i class="las la-music"></i>
									Your Tracks
								</a> <a href="artist_album.html"> <i class="las la-record-vinyl"></i>
									Your Albums
								</a> <a href="${pageContext.request.contextPath }/package/index">
									<i class="las la-crown yellow__icon"></i> Upgrade to Premium <i
									class="las la-crown yellow__icon"></i>
								</a> <a href="#"> <i class="las la-user-cog"></i> Settings
								</a> <a href="#"> <i class="las la-sign-out-alt"></i> Log out
								</a>
							</div>
						</div>
					</div>
	...
	<div class="player" id="audioPlayer">
		<div class="progressbar">
			<input type="range" class="audio-progress" max="100" min="0"
				value="0" step="0.01"> <span class="bar"></span>
		</div>
		<div class="audio">
		...
		<div class="audio-controls">
			...
			<div class="audio-controls-main">
				...
				<button class="btn-play-pause-audio default-btn circle__btn"
					onclick="audioControl(this);">
					<i class="las la-play audio__icon"></i> <i
						class="las la-pause audio__icon"></i>
				</button>
		...
		<div class="audio-info">
			...
			<span class="duration-info"> <span class="current-time">00:00</span>
				/ <span class="base-duration">03:22</span>
			</span>
			<div class="audio-control-volume">
				<button class="btn-toggle-volume default-btn"
					onclick="toggleMenuVolume('dropdown-volume-range')">
					<i class="las la-volume-up audio__icon"></i>
				</button>
				<div class="dropdown-volume-range">
					<input type="range" class="audio-volume" min="0" max="100"
						value="50" step="1" oninput="changeVolumeIcon(this)">
				</div>
			</div>
			<div class="dropleft">
				<button class="default-btn"
					onclick="toggleMenuSong('dropdown-song-menu', 'dropdown-song-link')">
				...
				<div class="dropdown-song-menu">
					<a class="dropdown-song-link favorite-link" data-favorite="true">
						<i class="las la-heart"></i> <span>Favorite</span>
					</a> <a class="dropdown-song-link"> <i
						class="las la-plus small__icon"></i> <span>Add to Playlist</span>
					</a> <a class="dropdown-song-link share-link" href="abc.com"> <i
						class="las la-share small__icon"></i> <span>Share</span>
					</a> <a class="dropdown-song-link" href="#"> <i
						class="las la-info-circle small__icon"></i> <span>Song Info</span>
					</a>
				</div>
			</div>
		...
		<div class="row row--grid">
			...
			<div class="col-6">
				<div class="lyric-content">
					...
					<p>I just start thinkin' crazy when you're on my mind (crazy
						when you're on my mind, yeah)</p>
					...
					<p>If we're said and done I know, I shouldn't say that</p>
					<p>I still care, but I still care</p>
					<p>And even when you're movin' on I hope you know that (I hope
						you know)</p>
					<p>I'll be there, I'll be there</p>
					<p>Be there for you</p>
					<p>Ooh, ooh</p>
	...
	<div class="playlist__box">
		<div class="playlist-title">
			<div class="playlist-title-content">Listen Special</div>
				...
				<button class="btn-dropdown-playlist-menu default-btn">
					...
					<div class="dropdown__playlist-item-menu">
						<a class="dropdown-song-link favorite-link" data-favorite="true">
							...
							class="las la-info-circle small__icon"></i> <span>Song
								Info</span>
						</a>
					</div>
				</button>
	...
	<audio
		src="${pageContext.request.contextPath }\resources\user\audio\advertisement\premium_sound.mp3"
		id="advertisement"></audio>
	<!-- audio end-->
	...
	<div class="timer">
		<i class="las la-stopwatch"></i> <span class="timer-left">05:00</span>
	...
	<!-- main content -->
	<main class="main">
		<button class="btn-track-id" data-id="1" onclick="getTrackById(this)">Button
			get track by id</button>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						<div class="footer__social">
							<a href="#" target="_blank"><svg width="30" height="30"
									...
									<path
										...
										fill="white" />
								</svg></a> <a href="#" target="_blank"><svg width="30" height="30"
									viewBox="0 0 30 30" fill="none"
									xmlns="../../../www.w3.org/2000/svg.html">
									<path
										d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
									...
									<path
										...
										fill="white" />
								</svg></a> <a href="../../../www.instagram.com/volkov_des1gn/index.html"
								target="_blank"><svg width="30" height="30"
									viewBox="0 0 30 30" fill="none"
									xmlns="../../../www.w3.org/2000/svg.html">
									<path
										d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
						...
						<small class="footer__copyright">� Volna, 2021. Created
							by <a
							href="../../../themeforest.net/user/dmitryvolkov/portfolio.html"
	...
	<form action="#" id="modal-ticket"
		...
		<div class="sign__group sign__group--row">
			<label class="sign__label">Your balance:</label> <span
				class="sign__value">$90.99</span>
		</div>

		<div class="sign__group sign__group--row">
			<label class="sign__label" for="value">Choose ticket:</label> <select
				class="sign__select" name="value" id="value">
				<option value="50">Regular - $49</option>
				<option value="100">VIP Light - $99</option>
				<option value="200">VIP - $169</option>
			</select> <span class="sign__text sign__text--small">You can spend
				money from your account on the renewal of the connected packages, or
				on the purchase of goods on our website.</span>
		</div>
	...
	<div id="modal-info2"
		...
		<span class="modal__icon modal__icon--green"> <svg
				xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
				<path
					d="M14.72,8.79l-4.29,4.3L8.78,11.44a1,1,0,1,0-1.41,1.41l2.35,2.36a1,1,0,0,0,.71.29,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,14.72,8.79ZM12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z">
				</path>
		...
		<div class="sign__group sign__group--row">
			<label class="sign__label">Total cost:</label> <span
				class="sign__value">$18.00</span>
		</div>

		<div class="sign__group sign__group--row">
			<label class="sign__label">Payment method: <b>Paypal</b></label> <span
				class="sign__text sign__text--small">There are many
	...
	<div id="modal-info3"
		class="zoom-anim-dialog mfp-hide modal modal--info">
		<span class="modal__icon modal__icon--red"> <svg
				xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
				<path
					d="M15.71,8.29a1,1,0,0,0-1.42,0L12,10.59,9.71,8.29A1,1,0,0,0,8.29,9.71L10.59,12l-2.3,2.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L12,13.41l2.29,2.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L13.41,12l2.3-2.29A1,1,0,0,0,15.71,8.29Zm3.36-3.36A10,10,0,1,0,4.93,19.07,10,10,0,1,0,19.07,4.93ZM17.66,17.66A8,8,0,1,1,20,12,7.95,7.95,0,0,1,17.66,17.66Z">
				</path>
	...
	<div id="modal-info4"
		...
		<div class="sign__group sign__group--row">
			<label class="sign__label">Amount to auto-renew:</label> <span
				class="sign__value">$18.00</span>
		</div>

		<div class="sign__group sign__group--row">
			<span class="sign__text sign__text--small">There are many
				variations of passages of Lorem Ipsum available, but the majority
				have suffered alteration in some form, by injected humour, or
				randomised words which don't look even slightly believable.</span>
		</div>
	...
	<div id="modal-info5"
		class="zoom-anim-dialog mfp-hide modal modal--info">
		<span class="modal__icon modal__icon--purple"> <svg
				xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
				<path
					d="M18,7h-.35A3.45,3.45,0,0,0,18,5.5a3.49,3.49,0,0,0-6-2.44A3.49,3.49,0,0,0,6,5.5,3.45,3.45,0,0,0,6.35,7H6a3,3,0,0,0-3,3v2a1,1,0,0,0,1,1H5v6a3,3,0,0,0,3,3h8a3,3,0,0,0,3-3V13h1a1,1,0,0,0,1-1V10A3,3,0,0,0,18,7ZM11,20H8a1,1,0,0,1-1-1V13h4Zm0-9H5V10A1,1,0,0,1,6,9h5Zm0-4H9.5A1.5,1.5,0,1,1,11,5.5Zm2-1.5A1.5,1.5,0,1,1,14.5,7H13ZM17,19a1,1,0,0,1-1,1H13V13h4Zm2-8H13V9h5a1,1,0,0,1,1,1Z">
				</path>
		...
		<div class="sign__group sign__group--row">
			<span class="sign__text sign__text--small">There are many
				variations of passages of Lorem Ipsum available, but the majority
				have suffered alteration in some form, by injected humour, or
				randomised words which don't look even slightly believable.</span> <span
				class="sign__text sign__text--small">There are many
				variations of passages of Lorem Ipsum available, but the majority
				have suffered alteration in some form, by injected humour, or
				randomised words which don't look even slightly believable.</span>
	...
	<!-- JS -->
	<script
		src="${pageContext.request.contextPath }/resources/user/js/jquery-3.5.1.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/bootstrap.bundle.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath }/resources/user/js/smooth-scrollbar.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/select2.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/slider-radio.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/jquery.inputmask.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/plyr.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/main.js"></script>
		
	<!-- My custom JS -->
	<script
		src="${pageContext.request.contextPath }/resources/user/css/sweetalert2/dist/sweetalert2.all.min.js"></script>
	<script defer type="module"
		src="${pageContext.request.contextPath }/resources/user/js/player/player.js"></script>
	<script defer type="module"
		src="${pageContext.request.contextPath }/resources/user/js/alert_custom.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/user/js/my_custom.js"></script>
														...
														.ajax({
															...
															success : function(
																...
																for (var i = 0; i < tracks.length; i++) {
																	var artists = ""
																	for (var j = 0; j < tracks[i].artist.length; j++) {
																		if (j == tracks[i].artist.length - 1) {
																			artists += "<a href='${pageContext.request.contextPath}/artist/"+ tracks[i].artist[j].id +"'>"
																					+ tracks[i].artist[j].nickname
																					+ "</a>"
																		} else {
																			artists += "<a href='${pageContext.request.contextPath}/artist/"+ tracks[i].artist[j].id +"'>"
																					+ tracks[i].artist[j].nickname
															...
															success : function(
																...
																for (var i = 0; i < albums.length; i++) {
																	htmls += "<div href='${pageContext.request.contextPath}/album/" + albums[i].id + "' class='album-box' data-id='" + albums[i].id + "'><div class='album-box-image'>"
																			...
																			+ "<div class='album-box-content'><p>"
																			+ albums[i].title
																			+ "</p><a href='${pageContext.request.contextPath}/playlist/" + albums[i].artistId + "'>"
																			+ albums[i].artistNickName
																			+ "</a></div></div>"
																}
																$(
																		"#album-container")
							...
							$("#artist-result-all")
									.click(
											function() {
												var keyword = $('.input-search')
														.val();
												var url = '${pageContext.request.contextPath }/track?keyword='
														+ keyword
														+ '&'
														+ 'type=artist'
