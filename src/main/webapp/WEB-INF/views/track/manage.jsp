			            ...
			            success: function (tracks) {
			                if(tracks){
					            ...
					            for(let i = 0; i < tracks.length; i++){
					            		htmls += "<div class='col-6 col-sm-4 col-lg-2'><div class='album'><div class='album__cover'>"
					            		...
					            		htmls += "<button class='btn-dropdown-track-menu-artist'><i class='las la-braille audio__icon'></i><div class='dropdown-track-menu-artist'><a class='dropdown-song-link-menu favorite-link'data-favorite='true'><i class='las la-heart'></i><span>Favorite</span></a><a class='dropdown-song-link-menu'><i class='las la-plus small__icon'></i><span>Add to Playlist</span></a><a class='dropdown-song-link-menu share-link' href='abc.com'><i class='las la-share small__icon'></i><span>Share</span></a><a class='dropdown-song-link-menu' href='#'><i class='las la-info-circle small__icon'></i><span>Song Info</span></a></div></button></div>"
					            		htmls += "<div class='album__title'><h3><a href='${pageContext.request.contextPath }/track/edit/"+ tracks[i].id +"'>"+tracks[i].title +"</a></h3></div></div></div>"
						        }
