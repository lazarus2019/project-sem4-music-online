	...
	<jsp:attribute name="content">
		...
		<div class="top__list">
				<div class="chart__header">
					<h3 class="top__list__header text-primary">Viet Nam Tracks Weekly</h3>
					<h5 class="weekly__date">${weeklyDate }</h5>
				</div>
					
				<ul class="main__list main__list--playlist main__list--dashbox">
					<c:forEach var="weeklyTrack" items="${weeklyTracks }" varStatus="i">
