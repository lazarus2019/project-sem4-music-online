...
<mt:userTemplate title="servicePackage">
	<jsp:attribute name="content">
		<!-- top chart -->
		<div class="release__list top__list">
			<h3></h3>
                            <ul class="main__list main__list--playlist main__list--dashbox">
                                <li class="single-item">
                                    <a data-playlist
					data-title="1. Got What I Got" data-artist="Jason Aldean"
					...
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
						alt="">
                                        <svg
						...
						alt="">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								...
								d="M16,2a3,3,0,0,0-3,3V19a3,3,0,0,0,6,0V5A3,3,0,0,0,16,2Zm1,17a1,1,0,0,1-2,0V5a1,1,0,0,1,2,0ZM8,2A3,3,0,0,0,5,5V19a3,3,0,0,0,6,0V5A3,3,0,0,0,8,2ZM9,19a1,1,0,0,1-2,0V5A1,1,0,0,1,9,5Z" />
                                    ...
                                    <div class="single-item__title">
                                        <h4>
							<a href="#">1. Got What I Got 1. Got What I Got 1. Got What I Got 1. Got
                                                What I Got 1. Got What I Got 1. Got What I Got</a>
						</h4>
                                        <span><a
							href="artist.html">Jason Aldean</a></span>
                                    </div>
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="2. Supalonely" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="3. Girls In The Hood" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="4. Got It On Me" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
						...
						alt="">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								...
								d="M16,2a3,3,0,0,0-3,3V19a3,3,0,0,0,6,0V5A3,3,0,0,0,16,2Zm1,17a1,1,0,0,1-2,0V5a1,1,0,0,1,2,0ZM8,2A3,3,0,0,0,5,5V19a3,3,0,0,0,6,0V5A3,3,0,0,0,8,2ZM9,19a1,1,0,0,1-2,0V5A1,1,0,0,1,9,5Z" />
                                    ...
                                    <div class="single-item__title">
                                        <h4>
							<a href="#">4. Got It On Me</a>
						</h4>
                                        <span><a
							href="artist.html">Jason Aldean & Alan Walker</a></span>
                                    </div>
                                    <a href="#" class="single-item__add">
                                        <svg
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="5. Righteous" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="6. Got What I Got" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					href="../blast2.0/audio/12071151_epic-cinematic-trailer_by_audiopizza_preview.mp3"
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="7. Supalonely" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					href="../blast2.0/audio/9106709_epic-adventure-cinematic-trailer_by_audiopizza_preview.mp3"
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="8. Girls In The Hood" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					href="../blast2.0/audio/10938456_inspiring-epic-motivational-cinematic-trailer_by_audiopizza_preview.mp3"
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="9. Got It On Me" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					href="../blast2.0/audio/16412111_upbeat-rock_by_audiopizza_preview.mp3"
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					...
					class="single-item__export">
							...
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <li class="single-item">
                                    <a data-playlist
					data-title="10. Righteous" data-artist="Jason Aldean"
					data-img="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
					href="../blast2.0/audio/19478377_ambient-pop_by_audiopizza_preview.mp3"
					class="single-item__cover">
                                        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover3.jpg"
