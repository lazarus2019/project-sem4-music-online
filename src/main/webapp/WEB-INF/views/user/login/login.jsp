...
<body>
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			...
			<li class="sidebar__nav-item"><a href="artists.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
			...
			<li class="sidebar__nav-item"><a href="releases.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
			...
			<li class="sidebar__nav-item"><a href="events.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
			...
			<li class="sidebar__nav-item"><a href="podcasts.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
							d="M12,15a4,4,0,0,0,4-4V5A4,4,0,0,0,8,5v6A4,4,0,0,0,12,15ZM10,5a2,2,0,0,1,4,0v6a2,2,0,0,1-4,0Zm10,6a1,1,0,0,0-2,0A6,6,0,0,1,6,11a1,1,0,0,0-2,0,8,8,0,0,0,7,7.93V21H9a1,1,0,0,0,0,2h6a1,1,0,0,0,0-2H13V18.93A8,8,0,0,0,20,11Z" /></svg>
					<span>Podcasts</span></a></li>

			<!-- collapse -->
			<li class="sidebar__nav-item"><a class="sidebar__nav-link"
				data-toggle="collapse" href="#collapseMenu1" role="button"
				aria-expanded="false" aria-controls="collapseMenu1"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
							d="M19,5.5H12.72l-.32-1a3,3,0,0,0-2.84-2H5a3,3,0,0,0-3,3v13a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V8.5A3,3,0,0,0,19,5.5Zm1,13a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V5.5a1,1,0,0,1,1-1H9.56a1,1,0,0,1,.95.68l.54,1.64A1,1,0,0,0,12,7.5h7a1,1,0,0,1,1,1Z" /></svg>
					<span>Pages</span> <svg xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24">
						<path
							d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z" /></svg></a>
			...
			<li class="sidebar__nav-item"><a href="store.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
			...
			<li class="sidebar__nav-item"><a href="news.html"
				class="sidebar__nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
						<path
    ...
    <div class="player__cover">
        <img src="${pageContext.request.contextPath }/resources/user/img/covers/cover.svg" alt="">
    </div>

    <div class="player__content">
        <span class="player__track"><b class="player__title">Epic Cinematic</b> <span class="player__artist">AudioPizza</span></span>
        <audio src="../blast2.0/audio/12071151_epic-cinematic-trailer_by_audiopizza_preview.mp3" id="audio" controls></audio>
    </div>
    </div> -->
	<!--<!--
...
<!-- end player -->
				...
				<div class="col-12">
					<div class="sign">
						<div class="sign__content">
							...
							<form
								action="${pageContext.request.contextPath }/user/login/processlogin"
								class="sign__form" method="post">
								<a href="index.html" class="sign__logo"> <img
									src="${pageContext.request.contextPath }/resources/user/img/logo.svg"
									alt="">
								</a>
								...
								<div class="sign__group">
									<input type="text" class="sign__input form-control"
										name="email" placeholder="Email">
								</div>

								<div class="sign__group">
									<input type="password" class="sign__input form-control"
										name="password" placeholder="Password">
								</div>

								<div class="sign__group sign__group--checkbox">
									<input id="remember" name="remember" type="checkbox"
										checked="checked"> <label for="remember">Remember
										Me</label>
								</div>
								...
								<div class="sign__social">
									<a class="fb"
										href="${pageContext.request.contextPath }/oauth2/authorization/facebook"><svg
											viewBox="0 0 9 17" fill="none"
											xmlns="../../../www.w3.org/2000/svg.html">
											<path
												d="M5.56341 16.8197V8.65888H7.81615L8.11468 5.84663H5.56341L5.56724 4.43907C5.56724 3.70559 5.63693 3.31257 6.69042 3.31257H8.09873V0.5H5.84568C3.1394 0.5 2.18686 1.86425 2.18686 4.15848V5.84695H0.499939V8.6592H2.18686V16.8197H5.56341Z" /></svg></a>
								...
								<span class="sign__text">Don't have an account? <a
									href="${pageContext.request.contextPath }/user/login/signup">Sign
										up!</a></span> <span class="sign__text"><a href="forgot.html">Forgot
										password?</a></span>
							</form>
	...
	<footer class="footer">
		<div class="container-fluid">
			<div class="row">
				<div
					class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
					...
					<p class="footer__tagline">
						Record Label & Internet Radio,<br> Online music HTML
						Template.
					</p>
					<div class="footer__links">
						<a href="mailto:support@volna.template"><svg
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								<path
							...
							support@volna.template</a> <a href="tel:82345678900"><svg
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								<path
				...
				<div
					...
					<div class="footer__nav">
						<a href="about.html">About</a> <a href="profile.html">My
							profile</a> <a href="pricing.html">Pricing plans</a> <a
				...
				<div
					...
					<div class="row">
						...
						<div class="col-6">
							<div class="footer__nav">
								<a href="artists.html">Artists</a> <a href="releases.html">Releases</a>
								<a href="events.html">Events</a> <a href="podcasts.html">Podcasts</a>
							</div>
						</div>

						<div class="col-6">
							<div class="footer__nav">
								<a href="news.html">News</a> <a href="store.html">Store</a> <a
									href="#">Music</a> <a href="#">Video</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div
					...
					<div class="footer__nav">
						<a href="privacy.html">Account & Billing</a> <a
							href="privacy.html">Plans & Pricing</a> <a href="privacy.html">Supported
							devices</a> <a href="privacy.html">Accessibility</a>
					</div>
				</div>
			</div>
						...
						<div class="footer__social">
							<a href="#" target="_blank"><svg width="30" height="30"
									...
									<path
										...
										fill="white" /></svg></a> <a href="#" target="_blank"><svg
									...
									<path
										...
										fill="white" /></svg></a> <a
								href="../../../www.instagram.com/volkov_des1gn/index.html"
								target="_blank"><svg width="30" height="30"
									...
									<path fill-rule="evenodd" clip-rule="evenodd"
										...
										fill="black"></path></g></svg></a> <a href="#" target="_blank"><svg
									width="30" height="30" viewBox="0 0 30 30" fill="none"
									xmlns="../../../www.w3.org/2000/svg.html">
									<path
										d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
									...
									<path
										...
										fill="white" />
									<path d="M13.5 18V13L17.5 15.5001L13.5 18Z" fill="#FF0000" /></svg></a>
						</div>
						<small class="footer__copyright">© Volna, 2021. Created by
							<a
	...
	<!-- Mirrored from dmitryvolkov.me/demo/volna/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Nov 2021 02:18:33 GMT -->
