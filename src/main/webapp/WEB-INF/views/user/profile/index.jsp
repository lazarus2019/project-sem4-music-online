...
>>>>>>> bdff0b746d5565cee4b2588a3890a29ecd444482
                              ...
                              <li>
                                 <div
									class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Request Becoming Artist </h6> <a
										class=" hero__btn hero__btn--green">Send Request </a>
                    ...
                    <div class="profile">
                        <div class="profile__user">
                            <div class="profile__avatar">
                                <img src=""
									${pageContext.request.contextPath }/resources/user/img/avatar.svg" alt="">
                            </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <img
																		src=""
																		${pageContext.request.contextPath }/resources/user/img/store/item3.jpg" alt="">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td>
                                                                <div
																	class="main__table-text">Aug 21, 2021</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text">17</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--price">$67.83</div>
                                                            </td>
                                                            <td>
                                                                <div
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--number">
																	<a href="#modal-info" class="open-modal">632</a>
																</div>
                                                            </td>
                                                            <td>
                                                                <div
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--number">
																	<a href="#modal-info" class="open-modal">708</a>
																</div>
                                                            </td>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <img
																		src=""
																		${pageContext.request.contextPath }/resources/user/img/store/item4.jpg" alt="">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
                                                            ...
                                                            <td>
                                                                <div
																	class="main__table-text">Aug 14, 2021</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text">1</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--price">$199</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--grey">
																	<svg xmlns="http://www.w3.org/2000/svg"
																		viewBox="0 0 24 24">
																		<path
																			d="M12,2A10,10,0,1,0,22,12,10.01114,10.01114,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8.00917,8.00917,0,0,1,12,20ZM14.09814,9.63379,13,10.26807V7a1,1,0,0,0-2,0v5a1.00025,1.00025,0,0,0,1.5.86621l2.59814-1.5a1.00016,1.00016,0,1,0-1-1.73242Z" /></svg>                                                                    On the way</div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <img
																		src=""
																		${pageContext.request.contextPath }/resources/user/img/store/item1.jpg" alt="">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text">
																	<a href="#">Vinyl Player</a>
																</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text">Aug 5, 2021</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text">1</div>
                                                            ...
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--price">$11 899</div>
                                                            </td>
                                                            <td>
                                                                <div
																	class="main__table-text main__table-text--green">
...
<<<<<<< HEAD
                                ...
                                <div class="${classProfile} ">
                                    <s:form
										action="${pageContext.request.contextPath }/user/profile/updateAccountFromSetting"
...
<<<<<<< HEAD
                                            ...
                                            <div
                                                ...
                                                <div class="sign__group">
                                                    ...
                                                    <s:input
																	path="firstname" class="sign__input" />
                                                </div>
                                            </div> 
                                            ...
                                            <div
                                                ...
                                                <div class="sign__group">
                                                    ...
                                                    <s:input
																	path="lastname" class="sign__input" />
                                                </div>
                                            </div>  
                                            ...
                                            <div
                                                ...
                                                <div class="sign__group">
                                                    ...
                                                    <s:input
																path="birthday" id="birthdayPicker" class="sign__input" />
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="sign__group">
                                                    ...
                                                    <s:textarea
																path="description" cols="10" rows="20"
																class="sign__input" />
...
=======
										...
										class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label
												class="sign__label" for="username">Login</label>
                                                    <input id="username"
												type="text" name="username" class="sign__input"
												placeholder="User123">
                                                </div>
                                            </div>
										...
										class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label
												class="sign__label" for="email">Email</label>
                                                    <input id="email"
												type="text" name="email" class="sign__input"
										...
										class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label
												class="sign__label" for="firstname">First name</label>
                                                    <input
										...
										class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label
												class="sign__label" for="lastname">Last name</label>
                                                    <input id="lastname"
												type="text" name="lastname" class="sign__input"
												placeholder="Doe">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <button
											class="sign__btn" type="button">Save</button>
                                            </div>
                                        </div>
                                    </form>
>>>>>>> bdff0b746d5565cee4b2588a3890a29ecd444482
...
<<<<<<< HEAD
                                ...
                                <div class="col-12 col-lg-6">
                                    <s:form
										action="${pageContext.request.contextPath }user/profile/updateAccountPasswordFromSetting"
...
=======
						...
						class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <label
								class="sign__label" for="select">Select</label>
                                                    <select
								name="select" id="select" class="sign__select">
                                            ...
                                            <div class="col-12">
                                                <button
							class="sign__btn" type="button">Change</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
