                        ...
                        <div class="iq-card-body profile-page">
                           <div class="profile-header">
                              <div class="cover-container text-center">
                                 <img src="${pageContext.request.contextPath }/resources/admin/images/user/1.jpg" alt="profile-bg" class="rounded-circle img-fluid">
                        ...
                        <div class="iq-card-body">
                           <ul class="list-inline p-0 mb-0">
                              ...
                              <li>
                                 <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Birthday</h6>
                                    <p class="mb-0"><fmt:formatDate pattern = "dd-MM-yyyy" value ="${accountSignined.birthday }" /></p>
                                 </div>
                              </li>
                              <li>
                                 <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Gender</h6>
                                    <p class="mb-0"> 
                                    	<c:if test="${accountSignined.gender == null }">Not selected yet</c:if> 
                              ...
                              <li>
                                 <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Email</h6>
                                    <p class="mb-0"> 
                                    	<c:if test="${accountSignined.email == null }">Not selected yet</c:if> 
...
=======
                              ...
                              <li>
                                 <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Country</h6>
                                    <p class="mb-0"> 
                                    	<c:if test="${accountSignined.country == null }">Not selected yet</c:if> 
                                    		${accountSignined.country.countryName }</p>
                                 </div>
                              </li>
                              <li>
...
>>>>>>> nts
                              ...
                              <li>
                                 <div class="d-flex align-items-center justify-content-between mb-3">
                                    <h6>Request Becoming Artist </h6> <a class=" hero__btn hero__btn--green" >Send Request </a>
...
=======
                                            <ul class="main__list main__list--dashbox">
                                                ...
                                                <li class="single-item">
                                                    <a data-link data-title="Supalonely" data-artist="BENEE Featuring" data-img=""${pageContext.request.contextPath }/resources/user/img/covers/cover7.jpg" href="../blast2.0/audio/9106709_epic-adventure-cinematic-trailer_by_audiopizza_preview.mp3" class="single-item__cover">
                                                ...
                                                <li class="single-item">
                                                    <a data-link data-title="Girls In The Hood" data-artist="Megan Thee" data-img=""${pageContext.request.contextPath }/resources/user/img/covers/cover8.jpg" href="../blast2.0/audio/10938456_inspiring-epic-motivational-cinematic-trailer_by_audiopizza_preview.mp3" class="single-item__cover">
                                                ...
                                                <li class="single-item">
                                                    <a data-link data-title="Got It On Me" data-artist="Summer Walker" data-img=""${pageContext.request.contextPath }/resources/user/img/covers/cover9.jpg" href="../blast2.0/audio/16412111_upbeat-rock_by_audiopizza_preview.mp3" class="single-item__cover">
                                                ...
                                                <li class="single-item">
                                                    <a data-link data-title="Righteous" data-artist="Juice WRLD" data-img=""${pageContext.request.contextPath }/resources/user/img/covers/cover10.jpg" href="../blast2.0/audio/19478377_ambient-pop_by_audiopizza_preview.mp3" class="single-item__cover">
                            ...
                            <div class="row row--grid">
                                <div class="col-12 col-md-6 col-lg-4 order-md-2 order-lg-1">
                                    <div class="plan plan--green">
                                        ...
                                        <ul class="plan__list">
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Volna
                                                Originals
                                            </li>
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Switch
                                ...
                                <div class="col-12 col-lg-4 order-md-1 order-lg-2">
                                    <div class="plan plan--red">
                                        ...
                                        <ul class="plan__list">
                                            ...
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Switch
                                                plans or cancel anytime</li>
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Stream
                                                65+ top Live</li>
                                            <li class="red"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13.41,12l4.3-4.29a1,1,0,1,0-1.42-1.42L12,10.59,7.71,6.29A1,1,0,0,0,6.29,7.71L10.59,12l-4.3,4.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L12,13.41l4.29,4.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42Z"/></svg>                                                Music channels</li>
                                        </ul>
                                        <button class="plan__btn" type="button">Select plan</button>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 order-md-3 order-lg-3">
                                    <div class="plan plan--purple">
                                        ...
                                        <ul class="plan__list">
                                            ...
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Stream
                                                65+ top Live</li>
                                            <li class="green"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z"/></svg> Music
                                                channels
                                            </li>
                                        </ul>
                                        <button class="plan__btn" type="button">Select plan</button>
...
<<<<<<< HEAD
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <s:label path="username" class="sign__label" >Username</s:label>
                                                    <s:input path="username" class="sign__input" />
                                                </div>
                                            </div> 
                                            </c:if>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                     <s:label path="nickname" class="sign__label" >Nickname</s:label>
                                                    <s:input path="nickname"   class="sign__input" />
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                     <s:label path="firstname" class="sign__label" >First name</s:label>
                                                    <s:input path="firstname"  class="sign__input" />
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <s:label path="lastname" class="sign__label" >Last name</s:label>
                                                    <s:input path="lastname"  class="sign__input" />
                                                </div>
                                            </div>  
											<div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                	<s:label path="email" class="sign__label" >Email</s:label>
                                                    <s:input path="email" class="sign__input" />
                                                </div>
                                            </div>
                                            </c:if>
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <s:label path="birthday" class="sign__label" >Birthday</s:label>
                                                    <s:input path="birthday" id="birthdayPicker"   class="sign__input" />
                                                </div>
                                            </div>
                                            
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <s:label path="gender" class="sign__label" >Gender</s:label>
                                                    <s:select path="gender" class="sign__input" items="${gender}">    </s:select>
                                                </div>
                                            </div>
                                            
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    <s:label path="country" class="sign__label" >Country</s:label>
                                                    <s:select path="country" class="sign__input" items="${countries}" itemLabel="countryName" itemValue="id">    </s:select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-12">
                                                <div class="sign__group">
                                                    <s:label path="description" class="sign__label" >Description</s:label>
                                                    <s:textarea path="description" cols="10" rows="20"  class="sign__input"/>
                                ...
                                <c:if test="${accountSignined.authProvider != auth }">
                                <div class="col-12 col-lg-6">
                                    <s:form action="${pageContext.request.contextPath }user/profile/updateAccountPasswordFromSetting" method="POST" 
                                    	name = "changePassword"
...
<<<<<<< HEAD
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="newpass" type="password" name="newpass" class="sign__input" required="required">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="confirmpass" type="password" name="confirmpass" class="sign__input" required="required">
                                                </div>
                                            </div>
