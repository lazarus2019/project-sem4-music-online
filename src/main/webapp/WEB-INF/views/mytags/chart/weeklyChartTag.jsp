									...
									<ul class="main__list">
										<c:forEach var="allWeeklyTrack" items="${allWeeklyTracks }" varStatus="i">
											<li class="single-item none-hover">
												...
												<a class="single-item__cover" data-link data-title="${allWeeklyTrack.title }" data-artist=""
													data-img="${pageContext.request.contextPath }/uploads/images/track/${allWeeklyTrack.thumbnail }"
													 onclick="getTrackById(this)" data-id="${allWeeklyTrack.id}">
												...
												<div class="single-item__title">
													...
													<span class="artist-nickname">
														<c:forEach var="artist" items="${allWeeklyTrack.accounts }" varStatus="j">
		                                    <a href="${pageContext.request.contextPath }/artist/id/${artist.id }">${artist.nickname}</a>
		                                    <c:if test="${(j.index+1) < allWeeklyTrack.artistLength}">, </c:if>
														</c:forEach>
													</span>
												</div>
										...
										<c:forEach var="usUkWeeklyTrack" items="${usUkWeeklyTracks }" varStatus="i">
											<li class="single-item none-hover">
												...
												<a data-link data-title="${usUkWeeklyTrack.title }" data-artist=""
													...
													onclick="getTrackById(this)" data-id="${usUkWeeklyTrack.id}"
										...
										<c:forEach var="vnWeeklyTrack" items="${vnWeeklyTracks }" varStatus="i">
											<li class="single-item none-hover">
												...
												<a data-link data-title="${vnWeeklyTrack.title }" data-artist=""
													...
													onclick="getTrackById(this)" data-id="${vnWeeklyTrack.id}"
													class="single-item__cover">
