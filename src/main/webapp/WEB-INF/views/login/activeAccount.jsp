                ...
                <div class="col-12">
                    <div class="sign">
                        <div class="sign__content">
                            ...
                            <form action="${pageContext.request.contextPath }/login/activeAccount" class="sign__form" method="post">
                                <a href="index.html" class="sign__logo">
                                    <img src="${pageContext.request.contextPath }/resources/user/img/logo.svg" alt="">
                                </a>
                                
                                <h3 class="mb-4 text-blue " >Confirm Account</h3>
								<c:if test="${msg != null }"><span class="sign__text"> ${msg } </span></c:if>
								
                                <div class="sign__group">
                                    <h5 class="text-white">Please enter the code we send to your email to verify </h5>
                                </div>
		
                                <div class="sign__group">
                                    <input type="text" class="sign__input form-control" name="emailcode" placeholder="Your code">

                                </div>                             

                                <input class="sign__btn" type="submit" value="Confirm"></input>
