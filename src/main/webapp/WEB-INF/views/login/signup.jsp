                ...
                <div class="col-12">
                    <div class="sign">
                        <div class="sign__content">
                            ...
                            action="${pageContext.request.contextPath }/user/login/register" class="sign__form" method="post">
                                ...
                                <span class="sign__text">Already have an account? <a href="${pageContext.request.contextPath }/user/login/">Sign In!</a></span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer__content">
                        ...
                        <small class="footer__copyright">Volna 2021<a href="../../../themeforest.net/user/dmitryvolkov/portfolio.html" target="_blank">Dmitry Volkov</a>.</small>
                    </div>
                </div>
            </div>
        </div>
